    ...
    GET = function(store)
        ...
        return function(req, res, next)
            ...
            elseif store_type == "mysql" then
                ...
                local success, err3, forcible = orange_db.set("divide.enable", data.enable)
                ...
                success, err3, forcible = orange_db.set_json("divide.rules", data.rules)
                if not success or err3 then
                    return res:json({
                        success = false,
