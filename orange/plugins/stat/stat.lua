...
function _M.stat()
    ...
    local load_timestamp = ngx.time() - status:get(KEY_START_TIME)
    load_timestamp = math.floor(load_timestamp / 86400) .. 'd ' .. math.floor(load_timestamp / 3600) .. 'h ' .. math.floor(load_timestamp / 60) ..'m'
