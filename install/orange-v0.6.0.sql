...
DROP TABLE IF EXISTS `rate_limiting_for_every_value`;

CREATE TABLE `rate_limiting_for_every_value` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `key` varchar(255) NOT NULL DEFAULT '',
  `value` varchar(2000) NOT NULL DEFAULT '',
  `type` varchar(11) DEFAULT '0',
...
LOCK TABLES `rate_limiting_for_every_value` WRITE;
/*!40000 ALTER TABLE `rate_limiting_for_every_value` DISABLE KEYS */;

INSERT INTO `rate_limiting_for_every_value` (`id`, `key`, `value`, `type`, `op_time`)
VALUES
	(1,'1','{}','meta','2016-11-11 11:11:11');

/*!40000 ALTER TABLE `rate_limiting_for_every_value` ENABLE KEYS */;
UNLOCK TABLES;
