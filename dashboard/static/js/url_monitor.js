            ...
            $("#view-btn").click(function(){//试图转换
                ...
                if(now_state == "table"){//当前是表格视图，点击切换到数据视图
                    ...
                    var showData = {
                        ...
                        monitor_rules: _this.data.rules
                    }
                                    ...
                                    $.ajax({
                                        ...
                                        success : function(result) {
                                            if(result.success){
                                                ...
                                                self.find("span").text("启用URL监控");
                                                
                                                return true;
                                            }else{
                                                L.Common.showErrorTip("提示", result.msg || "关闭URL监控发生错误");
                                                return false;
                                            }
                                        },
                                        error : function() {
                                            L.Common.showErrorTip("提示", "关闭URL监控请求发生异常");
                                            return false;
                                        }
                                    });
                                }
                                    ...
                                    $.ajax({
                                        ...
                                        success : function(result) {
                                            if(result.success){
                                                ...
                                                self.find("span").text("停用URL监控");
                                                
                                                return true;
                                            }else{
                                                L.Common.showErrorTip("提示", result.msg || "开启URL监控发生错误");
                                                return false;
                                            }
                                        },
                                        error : function() {
                                            L.Common.showErrorTip("提示", "开启URL监控请求发生异常");
                                            return false;
                                        }
                                    });
                                }
                                    ...
                                    $.ajax({
                                        ...
                                        success : function(result) {
                                            if(result.success){
                                                ...
                                                _this.data.rules = result.data.monitor_rules;//重新设置数据
