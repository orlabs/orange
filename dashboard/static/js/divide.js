                ...
                if(now_state == "yes"){//当前是开启状态，点击则“关闭”
                    var d = dialog({
                        ...
                        button: [{
                                ...
                                callback: function () {
                                    $.ajax({
                                        url : '/orange/dashboard/divide/enable',
                                        type : 'post',
                                        data: {
                                            enable: "0"
                                        },
                                        ...
                                        success : function(result) {
                                            if(result.success){
                                                ...
                                                _this.showErrorTip("提示", result.msg || "关闭分流功能发生错误");
                                                return false;
                                            }
                                        },
                                        error : function() {
                                            _this.showErrorTip("提示", "关闭分流功能请求发生异常");
                                            return false;
                                        }
                                    });
                                }
                                    ...
                                    $.ajax({
                                        ...
                                        success : function(result) {
                                            if(result.success){
                                                ...
                                                _this.showErrorTip("提示", result.msg || "开启分流功能发生错误");
                                                return false;
                                            }
                                        },
                                        error : function() {
                                            _this.showErrorTip("提示", "开启分流功能请求发生异常");
                                            return false;
                                        }
                                    });
                                }
                    ...
                    button: [{
                            ...
                            callback: function () {
                                ...
                                if(result.success == true){
                                    $.ajax({
                                        url : '/orange/dashboard/divide/configs',
                                        type : 'put',
                                        data: {
