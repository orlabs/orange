                                    ...
                                    $.ajax({
                                        ...
                                        success : function(result) {
                                            if(result.success){
                                                ...
                                                L.Common.showErrorTip("提示", result.msg || "关闭防火墙发生错误");
                                                return false;
                                            }
                                        },
                                        error : function() {
                                            L.Common.showErrorTip("提示", "关闭防火墙请求发生异常");
                                            return false;
                                        }
                                    });
                                }
                                    ...
                                    $.ajax({
                                        ...
                                        success : function(result) {
                                            if(result.success){
                                                ...
                                                L.Common.showErrorTip("提示", result.msg || "开启防火墙发生错误");
                                                return false;
                                            }
                                        },
                                        error : function() {
                                            L.Common.showErrorTip("提示", "开启防火墙请求发生异常");
                                            return false;
                                        }
                                    });
                                }
